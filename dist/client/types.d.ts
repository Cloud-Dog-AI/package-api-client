...
export type SSEEventType = "started" | "delta" | "progress" | "tool_call" | "completed" | "error";
...
export interface ApiClient {
    ...
    streamPostJsonLines(path: string, body: unknown, options: JsonLineStreamOptions): EventStreamHandle;
}
